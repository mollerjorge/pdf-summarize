 ...
 */
declare class OctoAIError extends Error {
 ...
 */
export declare class OctoAIValidationError extends OctoAIError {
}
/**
 * Client-side errors.  Indicated by HTTP codes from 400 through 499.
 */
export declare class OctoAIClientError extends OctoAIError {
}
/**
 * Server-side errors.  Indicated by HTTP codes from 500 through 599.
 */
export declare class OctoAIServerError extends OctoAIError {
}
/**
 ...
 */
export declare function throwOctoAIError(response: Response): Promise<void>;
/**
 * Standardized error message for requiring authorization.
 */
export declare function throwOctoAITokenRequiredError(): void;
export {};
